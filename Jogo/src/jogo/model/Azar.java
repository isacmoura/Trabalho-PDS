...
public class Azar extends SorteOuAzar{

	

	public Azar(String titulo, String descricao, int indice, Point coordenadaCasa) {
	...
	public void efeito(Jogador jogador) {
		...
		ViewController.getInstance().mostrarMensagemAzar(getDescricao(), getValor());
		jogador.pagar(getValor());
	}
